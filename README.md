...
1. **GET FREE SPIN ON POKEMON9 🎰** - Shows free spin promotional information with inline buttons:
...
- `TELEGRAM_CHANNEL` (Optional) - Telegram channel URL (default: `https://t.me/pokemon9`)
- `FREE_SPIN_URL` (Optional) - Free spin promotion URL (default: `https://pokemon9.com/RFPOKEMON9BOT9`)
- `FREE_CREDIT_URL` (Optional) - Free credit promotion URL (default: `https://pokemon9.com/RFPOKEMON9BOT9`)
...
```bash
docker build -t pokemon9-bot .
docker run -d --env-file .env pokemon9-bot
```
...
2. Create volume: `fly volumes create pokemon9_bot_data --size 1 --region sin`
...
**Pokemon9 Promo Bot** - Making marketing simpler! 🚀
